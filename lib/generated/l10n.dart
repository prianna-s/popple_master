...
class S {
  ...
  /// `{count} groups`
  String groups_with_count(Object count) {
    return Intl.message(
      '$count groups',
      name: 'groups_with_count',
      desc: '',
      args: [count],
    );
  }

  /// `{count} groups interested`
  String countGroupsInterested(Object count) {
    return Intl.message(
      '$count groups interested',
      name: 'countGroupsInterested',
      desc: '',
      args: [count],
    );
  }
